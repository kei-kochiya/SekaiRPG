...
var flags: Dictionary = {
	...
	"ena_released": false,
	"street_mission_started": false,
	"street_mission_ready": false,
	"street_skirmish_done": false,
	"street_skirmish_won": false,
	"street_survival_done": false,
	"street_survival_won": false,
